...
for line in data:
    ...
    bstree_lookup.append(line[4]*10**6)
    rbtree_lookup.append(line[5]*10**6)

plt.figure(figsize=(10, 6))

# curves
plt.plot(sizes, bstree_lookup, "s-", color="green", label="bstree_lookup_worst", markersize=4,
         linewidth=1.5)
plt.plot(sizes, rbtree_lookup, "x-", color="red", label="rbtree_lookup_worst", markersize=4,
         linewidth=1.5)

# Oy
plt.yscale('log')

y_ticks = [0.03, 0.05, 0.1, 0.5, 1, 5, 10, 50]
...
# save
plt.savefig("../out/graph1-2.png", dpi=175)
